...
The command below invokes the action server to execute a gesture (run in a new terminal) with the request parameters defined below:
   ```bash
   rostopic pub /gestureExecution/goal gestureExecution/GestureExecutionActionGoal \
  "header:
    seq: 0
  ...
  goal:
    ...
    gesture_arm: <gesture_arm>
    deictic_shape: <palm_orientation>
    gesture_duration: <gesture_duration>
    bow_nod_angle: <bow_nod_angle>
    point_location_x: <point_location_x>
    point_location_y: <point_location_y>
    point_location_z: <point_location_z>"
   ```
### Request Parameters
...
#### 6. Pointing Location (point_location_x, point_location_y, point_location_z)
...
- <span style="color: #cccccc; font-weight: bold;">Deictic (Pointing) gesture at (`3, 3, 0.82`) for `2000 ms`: </span>
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'deictic', gesture_id: 1, gesture_arm: 'LEFT', palm_orientation: 'PALM_UPWARDS', gesture_duration: 2000, bow_nod_angle: 0, point_location_x: 3, point_location_y: 3, point_location_z: 0.82}"
   ```
...
* <span style="color: #cccccc; font-weight: bold;">Iconic open hands (`welcome`) gesture for `3000 ms`: </span>
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'iconic', gesture_id: 01, gesture_arm: '', palm_orientation: '', gesture_duration: 3000, bow_nod_angle: 0, point_location_x: 0, point_location_y: 0, point_location_z: 0}"
   ```
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'iconic', gesture_id: 02, gesture_arm: '', palm_orientation: '', gesture_duration: 3000, bow_nod_angle: 0, point_location_x: 0, point_location_y: 0, point_location_z: 0}"
   ```
...
- <span style="color: #cccccc; font-weight: bold;">Iconic wave (`goodbye`) gesture for `4000 ms`: </span>
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'iconic', gesture_id: 03, gesture_arm: '', palm_orientation: '', gesture_duration: 4000, bow_nod_angle: 0, point_location_x: 0, point_location_y: 0, point_location_z: 0}"
   ```
...
- <span style="color: #cccccc; font-weight: bold;">Iconic `handshake` gesture for `3000 ms`: </span>
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'iconic', gesture_id: 04, gesture_arm: '', palm_orientation: '', gesture_duration: 3000, bow_nod_angle: 0, point_location_x: 0, point_location_y: 0, point_location_z: 0}"
   ```
   <span style="color: #cccccc; font-weight: bold;">or</span>
   ```sh
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'iconic', gesture_id: 05, gesture_arm: '', palm_orientation: '', gesture_duration: 3000, bow_nod_angle: 0, point_location_x: 0, point_location_y: 0, point_location_z: 0}"
   ```
...
- <span style="color: #cccccc; font-weight: bold;">Bowing at `30 degrees` for `2000 ms`: </span>
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'bow', gesture_id: 01, gesture_arm: '', palm_orientation: '', gesture_duration: 2000, bow_nod_angle: 30, point_location_x: 0, point_location_y: 0, point_location_z: 0}"
   ```
...
- <span style="color: #cccccc; font-weight: bold;">Nodding at `15 degrees` for `1000 ms`: </span>
   ...
   ```
   ```sh
   rostopic pub --once /gestureExecution/perform_gesture/goal gestureExecution/GestureExecutionActionGoal "goal: {gesture_type: 'nod', gesture_id: 01, gesture_arm: '', palm_orientation: '', gesture_duration: 1000, bow_nod_angle: 15, point_location_x: 0, point_location_y: 0, point_location_z: 0}"
   ```
