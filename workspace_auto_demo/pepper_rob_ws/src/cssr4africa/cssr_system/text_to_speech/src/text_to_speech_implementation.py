...
things_to_say = {
    "And this one is another Pepper robot, just like me! We are semi-humanoid robots developed by SoftBank Robotics, designed for human interaction and companionship. Together, we are part of a research project called Culturally-Sensitive Social Robotics for Africa. The idea behind that, is to help robots like me learn how to incorporate social customs and traditions during interactions with people in Africa. Not just with words, but also with gestures, expressions, and body language!":"pepper.wav",
    "Over here, we have the Lynxmotion. It is a robotic arm that can move a bit like a human arm. It can reach out, pick things up, and place them down. Robots like this are often used for tasks that require precision, such as in factories or laboratories. Here, we use it for teaching robot manipulation":"lynxmotion.wav",
    "And over here, we have the Roomba. It is an autonomous robotic vacuum cleaner, manufactured by iRobot. It can navigate and clean floors on its own. We use it for teaching mobile robotics in the robotics courses here at CMU Africa.":"roomba.wav",
    "Hello everyone! Welcome to the AI and Robotics lab, here at Carnegie Mellon University Africa. My name is Pepper. I am what is called a Humanoid Robot. That means I was designed to look, move and act like you, humans! For today, I will be your tour guide.":"welcome.wav",
    "Stand back and watch, as I go around the lab and explain some of the things we do here.":"standback.wav",
    "That marks the last item on the tour. If you have any further questions, please ask my colleagues here.":"4.wav",
    "That is it from me. I hope you enjoyed the tour of the AI & Robotics Lab here at Carnegie Mellon University Africa.":"5.wav",
    "Hi there. Would you like a tour of the lab?":"a.wav",
    "No problem. Perhaps we can do it another time.":"b.wav",
    "Now, we move on to the best part of the tour. The star of the main project done here at the lab.":"b-r-p.wav",
    "I Hope to meet with you again soon. I will be right here, ready for our next adventure. See you soon!":"8.wav"
}
        ...
        try:
            if language == 'english':
                ...
                subprocess.Popen([
                        self.python2_path, 
                        self.python2_script,
                        os.path.join(os.path.dirname(__file__), f"../audio/{things_to_say[message]}"),
                        self.config['ip'],
                        self.config['port']
                ])
