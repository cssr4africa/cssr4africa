...
2. **Clone and build the project (if not already cloned)**:
   ...
   - Install required linux tools
      ...
      sudo apt-get install cython3 ffmpeg gfortran libopenblas-dev libopenblas64-dev patchelf pkg-config portaudio19-dev python3-testresources python3.10-tk python3-typing-extensions sox
       ```
